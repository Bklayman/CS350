...
80102f68:	68 44 74 10 80       	push   $0x80107444
80102f6d:	e8 3e d7 ff ff       	call   801006b0 <cprintf>
cprintf("This is an added line by Brendan Klayman\n");
80102f72:	c7 04 24 58 74 10 80 	movl   $0x80107458,(%esp)
80102f79:	e8 32 d7 ff ff       	call   801006b0 <cprintf>
  idtinit();       // load idt register
80102f7e:	e8 1d 28 00 00       	call   801057a0 <idtinit>
  xchg(&(mycpu()->started), 1); // tell startothers() we're up
80102f83:	e8 c8 08 00 00       	call   80103850 <mycpu>
...
80102f8a:	b8 01 00 00 00       	mov    $0x1,%eax
80102f8f:	f0 87 82 a0 00 00 00 	lock xchg %eax,0xa0(%edx)
  scheduler();     // start running processes
80102f96:	e8 15 0c 00 00       	call   80103bb0 <scheduler>
...
8010311e:	68 82 74 10 80       	push   $0x80107482
...
801031d6:	68 9f 74 10 80       	push   $0x8010749f
...
80103278:	ff 24 95 c4 74 10 80 	jmp    *-0x7fef8b3c(,%edx,4)
8010327f:	90                   	nop
...
801032a3:	68 87 74 10 80       	push   $0x80107487
...
8010332d:	68 a4 74 10 80       	push   $0x801074a4
...
801033d0:	00 00 00 
  initlock(&p->lock, "pipe");
801033d3:	68 d8 74 10 80       	push   $0x801074d8
...
80103836:	68 dd 74 10 80       	push   $0x801074dd
...
801039bf:	68 0d 75 10 80       	push   $0x8010750d
801039c4:	50                   	push   %eax
801039c5:	e8 76 0d 00 00       	call   80104740 <safestrcpy>
  p->cwd = namei("/");
801039ca:	c7 04 24 16 75 10 80 	movl   $0x80107516,(%esp)
...
80103a03:	68 f4 74 10 80       	push   $0x801074f4
...
80103e2d:	68 65 75 10 80       	push   $0x80107565
80103e32:	e8 59 c5 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103e37:	83 ec 0c             	sub    $0xc,%esp
80103e3a:	68 58 75 10 80       	push   $0x80107558
...
80103f49:	68 77 75 10 80       	push   $0x80107577
80103f4e:	e8 3d c4 ff ff       	call   80100390 <panic>
    panic("sleep");
80103f53:	83 ec 0c             	sub    $0xc,%esp
80103f56:	68 71 75 10 80       	push   $0x80107571
...
8010416c:	74 ea                	je     80104158 <procdump+0x28>
      state = "???";
8010416e:	ba 88 75 10 80       	mov    $0x80107588,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104173:	83 f8 05             	cmp    $0x5,%eax
80104176:	77 11                	ja     80104189 <procdump+0x59>
80104178:	8b 14 85 e8 75 10 80 	mov    -0x7fef8a18(,%eax,4),%edx
      state = "???";
8010417f:	b8 88 75 10 80       	mov    $0x80107588,%eax
...
8010418e:	68 8c 75 10 80       	push   $0x8010758c
...
801041fa:	68 00 76 10 80       	push   $0x80107600
...
801044ab:	68 0b 76 10 80       	push   $0x8010760b
...
80104505:	68 13 76 10 80       	push   $0x80107613
8010450a:	e8 81 be ff ff       	call   80100390 <panic>
    panic("popcli");
8010450f:	83 ec 0c             	sub    $0xc,%esp
80104512:	68 2a 76 10 80       	push   $0x8010762a
...
80104531:	68 31 76 10 80       	push   $0x80107631
...
80104980:	68 39 76 10 80       	push   $0x80107639
